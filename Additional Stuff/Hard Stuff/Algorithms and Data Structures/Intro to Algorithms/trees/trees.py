'''
Binary tree is a tree data structure in which each node has at most who children
...
Full binary tree - a full binary tree (referred ot as a proper or plane binary tree) is
...
preorder - check if current node is empty
        display the data part of the root or current node
        traverse the left sunbtree by recursively calling the pre-order function
        traverse the right subtree by recursively calling the pre-order function

inorder - check if the current node is empty
        traverse the left subtree by recurseively calling the inorder function
        display the data part of the root or current node
        traverse the right subtree by recursively calling the inorder funciton
'''
