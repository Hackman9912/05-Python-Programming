...
************** Binary Search of a Sorted List **************
    Used to seach an ordered list for a particular value
    Divide and conquer approach(logarithmic)
...
print(binarySearch(3, my_list))
    ...
    '''
    For a list of size n we pwerform the reduction n/2/2/2... until we get to 1
