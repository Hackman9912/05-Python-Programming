...
class CellPhone:
    ...
    # the set_manufact method accepts an argument for the phones manufacturer
    def set_manufact(self, manufact):
        self.__manufact = manufact

    # The set_model method accepts an argument for the phones model
    def set_model(self, model):
        self.__model = model

    # The set_retail_price method accepts an argument for the phones retail price
    ...
    # The get_model method returns the phones model
    def get_model(self):
        return self.__model
