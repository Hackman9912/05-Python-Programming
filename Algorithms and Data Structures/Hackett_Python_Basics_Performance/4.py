"""
25/25 points
Well done on this one. The only thing to note is that your range function should take in 21, remember
that range goes up to what you input, but doesn't include it.
Get with your classmates to see a more compact version of this program as well. 
"""
